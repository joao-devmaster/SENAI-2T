...
using ProjetoNyous.Contexts;
using ProjetoNyous.Domains;
using ProjetoNyous.Utils;

namespace ProjetoNyous.Controllers
{
    ...
    {   
        ...
        //capturar as informações do token do appsettings.json
        ...
        //criamos um metodo para validar nosso usuario da aplicação
        ...
        //pegar info de acesso por escrito , ex: padrão ou adm
        ...
        public IActionResult Login([FromBody] Usuario login)
        {
            ...
            //chamamos nosso metodo de criptografia
